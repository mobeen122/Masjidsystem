...
use App\Models\Faculty\RememberTokens;
use App\Models\Faculty\SuccessLogins;
...
class Auth extends Component
{
     ...
     * @param int $userId
     */
    public function registerUserThrottling(Users $user)
    {
    ...
    public function createRememberEnvironment(Users $user)
    {
        ...
        $token = $this->security->hash($user->email . $user->password . $userAgent);
    ...
    public function loginWithRememberMe()
    {
        ...
        if ($user) {
            ...
            $userAgent = $this->request->getUserAgent();
            $token = $this->security->hash($user->email. $user->username . $user->password . $userAgent);
